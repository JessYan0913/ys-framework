...
export default async function InformationCollectionPage({ params }: ProtocolPageProps) {
  // locale参数暂时未使用，但保留以备将来国际化需要
  void params.locale;

  try {
    const filePath = path.join(process.cwd(), 'public', 'protocol', 'YS Framework-信息收集.md');
