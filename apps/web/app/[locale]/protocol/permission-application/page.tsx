...
export default async function PermissionApplicationPage({ params }: ProtocolPageProps) {
  // locale参数暂时未使用，但保留以备将来国际化需要
  void params.locale;

  try {
    const filePath = path.join(process.cwd(), 'public', 'protocol', 'YS Framework-权限申请.md');
